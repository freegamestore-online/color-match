    ...
    <GameShell topbar={<GameTopbar title="Color Match" score={score} />}>
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', gap: '1rem', padding: '1rem', touchAction: 'none' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
          ...
          <span style={{ color: 'var(--muted)', fontSize: '0.75rem', fontFamily: 'monospace' }}>Col {currentCol + 1}</span>
        </div>

        {/* Game board */}
        <div style={{ position: 'relative', width: boardWidth, height: boardHeight, background: 'rgba(0,0,0,0.3)', borderRadius: 12, padding: 0 }}>
          {/* Column highlight */}
          {!gameOver && (
            <div style={{
              position: 'absolute',
